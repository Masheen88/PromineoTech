...
function flipTiles(firstTurn, secondTurn, firstTurnID, secondTurnID, playerId) {
  ...
  for (let i = 0; i <= 9; i++) {
    $(`.gameCell-${i}`).click(function () {
      ...
      //Check if players wins by row 1, column 1 or diagonal spaces (1,5,9)
      if (
      ...
      //Check if players wins by row 3 or column 3
      else if (
      ...
      //Check if players wins by row 2, column 2, or diagonal spaces (3,5,7)
      else if (
